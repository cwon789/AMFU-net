...
class AMFU(nn.Module):
    ...
    def forward(self, inputs):
        ...
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(
            self.cat_attn(torch.cat((h1_PT_hd4, h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4), 1))))) # hd4_cat->[16, 40, 32, 32] [B, C, W, H] / filter 8 
        ...
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            self.cat_attn(torch.cat((h1_PT_hd3, h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3), 1))))) # hd3_cat->[16, 40, 64, 64] [B, C, W, H] / filter 8
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(
            self.cat_attn(torch.cat((h1_PT_hd2, h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2), 1))))) # hd2_cat->[16, 40, 128, 128] [B, C, W, H] / filter 8
        ...
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(
            self.cat_attn(torch.cat((h1_Cat_hd1, hd2_UT_hd1, hd3_UT_hd1, hd4_UT_hd1, hd5_UT_hd1), 1))))) # hd1_cat->[16, 40, 256, 256] [B, C, W, H] / filter 8
