...
# Video writer
# out = cv2.VideoWriter("UNet2.mp4",cv2.VideoWriter_fourcc(*"mp4v"), 30,(256,256))   # if 3 channel images
out = cv2.VideoWriter("DNA_Res_18.mp4",cv2.VideoWriter_fourcc(*"mp4v"), 30,(256,256), 0)   # if grayscale
